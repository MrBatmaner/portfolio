...
function Skills({ skills }: Props) {
  return (
    <motion.div
      ...
      className="relative flex flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 justify-center xl:space-y-0 mx-auto min-h-screen items-center"
    >
      ...
      <div className="grid grid-cols-4 gap-2 md:gap-5 lg:gap-5 xl:gap-5">
